...
GD::GameObject * DD::DigDugPrefabs::CreateMenuButton()
{
	return nullptr;
}
...
GD::GameObject * DD::DigDugPrefabs::CreateDigDug(GD::Scene& scene, GD::ControllerIndex index )
{
	...
	Sprite* digDugSprite = new Sprite(go_DigDug->CreateTexture(), "DigDug");
	...
	digDugSprite->AddAnimation(static_cast<unsigned int>(StateID::Dying), Animation{ 5, 0.3f, { {0, 16.f}, {80.f, 32.f} } });
...
GD::GameObject* DD::DigDugPrefabs::CreatePooka(GD::Scene& scene, GD::ControllerIndex index)
{
	...
	Sprite* pookaSprite = new Sprite(go_Pooka->CreateTexture(), "Pooka");
	...
	pookaSprite->AddAnimation(static_cast<unsigned int>(StateID::Floating), Animation{ 2, 0.25f, { {32.f, 0}, {64.f, 16.f} } });
	pookaSprite->AddAnimation(static_cast<unsigned int>(StateID::Dying), Animation{ 1, 0, { {64.f, 0}, {70.f, 16.f} } });
...
GD::GameObject * DD::DigDugPrefabs::CreateFygar(GD::Scene& scene, GD::ControllerIndex index )
{
	...
	Sprite* fygarSprite = new Sprite(go_Fygar->CreateTexture(), "Fygar");
	...
	fygarSprite->AddAnimation(static_cast<unsigned int>(StateID::Floating), Animation{ 2, 0.25f, { {32.f, 0}, {64.f, 16.f} } });
	fygarSprite->AddAnimation(static_cast<unsigned int>(StateID::Dying), Animation{ 1, 0, { {64.f, 0}, {70.f, 16.f} } });
	fygarSprite->AddAnimation(static_cast<unsigned int>(StateID::BreathingFire), Animation{ 1, 0, { {70.f, 0}, {86.f, 16.f} } });
